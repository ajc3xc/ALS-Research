...
Ex = pd.read_csv(r"C:\Users\13144\Desktop\WGS_Variant_Analysis_jp_ALS_Exp.csv")
Em = pd.read_csv(r"C:\Users\13144\Desktop\WGS_Variant_Analysis_jp_ALS_Emp.csv")
cEx = pd.read_csv(r"C:\Users\13144\Desktop\WGS_Variant_Analysis_jp_Ctr_Exp.csv")
cEm = pd.read_csv(r"C:\Users\13144\Desktop\WGS_Variant_Analysis_jp_Ctr_Emp.csv")
...
highCtrCrds = []
for c in crds:
    a = Em.iat[ c[0], c[1] ] / Ex.iat[ c[0],c[1] ]
...
plt.savefig(r"C:\Users\13144\Desktop\Variant_FoldChange_scatterplot_Enlarged.png")
#delete scatterplot
plt.clf()
print("Saved")
...
plt.savefig(r"C:\Users\13144\Desktop\Variant_Empirical_Scatterplot_Enlarged.png")
print("Saved")